...
2. Check to postfix notation that is produced by the code. I use this online tool to help my job: [https://www.mathblog.dk/tools/infix-postfix-converter/](https://www.mathblog.dk/tools/infix-postfix-converter/). That's another
